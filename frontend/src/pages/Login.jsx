    ...
    <AppShell>
      <div className="max-w-md mx-auto py-12">
        <Card>
          ...
          <button
            type="button"
            className="w-full mt-4 flex items-center justify-center gap-2 bg-white text-gray-700 font-pixel text-xs px-4 py-2 border-4 border-gray-500 hover:bg-gray-200 cursor-pointer transition-colors"
            onClick={() => {
